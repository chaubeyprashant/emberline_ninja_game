    ...
    public static class Session
    {
        ...
        public static readonly LevelDef[] Story =
        {
            ...
            new() { id = 2, name = "THE LANTERN ROAD", marsh = false,
                story = "They are cutting the lantern posts. Hold the road until the bells ring.",
                dialogue = new[]
                {
                    "YOTSU|They're cutting the posts. Without light, the road belongs to them.",
                    "RENZO|Then I'll hold it until the temple bells ring.",
                    "YOTSU|Ninety heartbeats of dark. Guard the road like family.",
                },
                debrief = "Among the ashes, a raider's note: 'The old flame hangs at the guard's belt.' They know his lantern now.",
                holdSeconds = 90f,
                waves = new[] { W(B, B), W(B, R), W(B, B, R) } },
            ...
            new() { id = 3, name = "EYES IN THE DARK", marsh = false,
                ...
                dialogue = new[]
                {
                    ...
                    "YOTSU|Old stories say the marsh sends its drowned to fetch what it wants.",
                    "RENZO|Then tonight the dead learn to fear the light.",
                },
                debrief = "The shade dissolved without a sound — reaching, until the very end, for the lantern.",
            ...
            new() { id = 5, name = "THE SERPENT'S TRAIL", marsh = true,
                ...
                waves = new[] { W(B, B, S, R), W(S, S, B, B, R) } },
